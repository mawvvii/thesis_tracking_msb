...
def get_dataloader(dataset_name, split, batch_size, \
    ...
    if dataset_name == 'CIFAR10':
        data_root_list = ['/scratch/users/Maryam/Thesis_Tracking/L-DNQ/data','/home/shangyu/CIFAR10', '/home/sinno/csy/CIFAR10', '/data/CIFAR10', '~/Documents/datasets/CIFAR10']
        # Default data root
...
def get_modified_dataloader(dataset_name, split, batch_size, \
                   shuffle = True, drop_last = True, ratio=-1, resample=False):
    ...
    if dataset_name == 'CIFAR10':
        data_root_list = ['/scratch/users/Maryam/Thesis_Tracking/L-DNQ/CIFAR10_modified100','/scratch/users/Maryam/Thesis_Tracking/L-DNQ/CIFAR10_50percent','/home/shangyu/CIFAR10', '/home/sinno/csy/CIFAR10', '/data/CIFAR10', '~/Documents/datasets/CIFAR10']
        # Default data root
        data_root = data_root_list[0]
        for data_root in data_root_list:
            if os.path.exists(data_root):
