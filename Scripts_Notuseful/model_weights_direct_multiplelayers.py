...
import pandas as pd
import numpy as np
from weightflipping import inject_errors_into_state_dict_random_lower_16, inject_errors_into_state_dict_lsb
...
state_dict = torch.load('/scratch/users/Maryam/Thesis_Tracking/L-DNQ/SmallerModels/essential_layers_model_16.pth')
# # Inject errors with a certain probability
flip_probability = 1  # For example, 10% of the weights will have bit flips
corrupted_state_dict = inject_errors_into_state_dict_lsb(state_dict, flip_probability)
...
for threshold in thresholds:
    ...
    df = pd.DataFrame(data, columns=[
        ...
        'Num_Layers_Used', 'Top_Prob_Layer1', 'Top_Prob_Layer2', 'Top_Prob_Layer3'
    ])
...
with pd.ExcelWriter('multipleLayers_essential_faultyweight_100percent_lower16.xlsx', engine='xlsxwriter') as writer:
