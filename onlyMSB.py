...
import sys
sys.path.append('/scratch/users/Maryam/Thesis_Tracking/pytorch_resnet_cifar10/resnet.py')  # Add the path to your cloned repository
import torchvision.models as models
# from pytorch_resnet_cifar10 import resnet  # Import the ResNet32 model from the repository
...
# def plot_sensitivity_scores(sensitivity_scores):
...
#     plt.title('Parameter Sensitivity Scores in Model')
...
# print("Model Summary:")
# summary(model, input_size=(3, 32, 32), device=str('cuda'))  # Adjust input size as necessary
# model.summary()
